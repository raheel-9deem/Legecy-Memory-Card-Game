...
import { Router, ROUTES } from './core/router.mjs';
import { gameManager, GAME_STATE } from './core/game.mjs';
import { header } from './ui/header.mjs';
import { particles } from './ui/particles.mjs';
import { initToast, toast } from './ui/toast.mjs';
