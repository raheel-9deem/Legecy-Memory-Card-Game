...
export const ROUTES = {
  menu:   { elementId: 'screen-menu',         loader: () => import('../screens/menu.js') },
  levels: { elementId: 'screen-level-select', loader: () => import('../screens/level-select.js') },
  game:   { elementId: 'screen-gameplay',     loader: () => import('../screens/gameplay.js') },
  store:  { elementId: 'screen-store',        loader: () => import('../screens/store.js') },
  win:    { elementId: 'screen-win',          loader: () => import('../screens/win.js') },
};
